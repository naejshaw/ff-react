...
```sh {"id":"01J5DMK6TKYJPTSJQKK1WSA9B7"}
my-app/
  README.md
  node_modules/
  package.json
...
```js {"id":"01J5DMK6TNTNF16F0X36N4SQWF"}
...
```json {"id":"01J5DMK6TNTNF16F0X371853HE"}
...
```sh {"id":"01J5DMK6TNTNF16F0X3AE848RA"}
...
```json {"id":"01J5DMK6TQVG1QM8Z9BZSE3M6J"}
{
  "version": "0.2.0",
  "configurations": [{
    "name": "Chrome",
...
```sh {"id":"01J5DMK6TRWWDNN43MK48TNNYS"}
...
```js {"id":"01J5DMK6TRWWDNN43MK66PMS9Q"}
...
```js {"id":"01J5DMK6TRWWDNN43MK7CGPRY7"}
import React, { Component } from 'react';
...
```css {"id":"01J5DMK6TRWWDNN43MKAJCF7GH"}
.Button {
  padding: 20px;
}
```
...
```js {"id":"01J5DMK6TRWWDNN43MKCT9687N"}
import React, { Component } from 'react';
...
```css {"id":"01J5DMK6TSN2PVEQYSD5CZ378S"}
.App {
  display: flex;
  flex-direction: row;
  align-items: center;
...
```css {"id":"01J5DMK6TSN2PVEQYSD6PER3V0"}
.App {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
```sh {"id":"01J5DMK6TSN2PVEQYSD6QFSG5X"}
npm install node-sass --save-dev
```

Then in `package.json`, add the following lines to `scripts`:

```diff {"id":"01J5DMK6TSN2PVEQYSD7TQPKBX"}
   "scripts": {
...
```sh {"id":"01J5DMK6TSN2PVEQYSDBKMNNAK"}
npm install --save-dev npm-run-all
```

Then we can change `start` and `build` scripts to include the CSS preprocessor commands:

```diff {"id":"01J5DMK6TTHYX97MNYSTQVFKWX"}
   "scripts": {
     "build-css": "node-sass src/ -o src/",
     "watch-css": "npm run build-css && node-sass src/ -o src/ --watch --recursive",
-    "start": "react-scripts start",
...
```js {"id":"01J5DMK6TTHYX97MNYSY1G4KM3"}
...
```css {"id":"01J5DMK6TTHYX97MNYT15P9M05"}
.Logo {
...
```html {"id":"01J5DMK6TVV170N74ZMRT06MAR"}
...
```js {"id":"01J5DMK6TVV170N74ZMT31T7D1"}
render() {
...
```js {"id":"01J5DMK6TVV170N74ZMX7HAARF"}
const $ = window.$;
```
...
```sh {"id":"01J5DMK6TWPN7C39PK4EEPATST"}
...
```js {"id":"01J5DMK6TWPN7C39PK4GRP4C17"}
...
```js {"id":"01J5DMK6TWPN7C39PK4GS6DWCC"}
...
```jsx {"id":"01J5DMK6TXMAZGPT71FPCYHM6M"}
render() {
  return (
    <div>
...
```html {"id":"01J5DMK6TXMAZGPT71FSBEN71Z"}
<div>
...
```js {"id":"01J5DMK6TXMAZGPT71FVWQSFCC"}
...
```html {"id":"01J5DMK6TYQQ7RM68CQ7VWSS99"}
...
```cmd {"id":"01J5DMK6TYQQ7RM68CQ86FQJME"}
...
```bash {"id":"01J5DMK6TYQQ7RM68CQ9NQPTR5"}
...
```sh {"id":"01J5DMK6TYQQ7RM68CQCXQEH5H"}
...
```sh {"id":"01J5DMK6TZYS50QMFVVFMJ2VZR"}
...
```js {"id":"01J5DMK6TZYS50QMFVVHR1Z84P"}
...
```ini {"id":"01J5DMK6TZYS50QMFVVMRCAK9W"}
...
```cmd {"id":"01J5DMK6V0MH1Q050XCK8MN58N"}
...
```bash {"id":"01J5DMK6V0MH1Q050XCP0W7C2Q"}
...
```html {"id":"01J5DMK6V0MH1Q050XCR5XSDS4"}
<!doctype html>
<html lang="en">
  <head>
...
```js {"id":"01J5DMK6V0MH1Q050XCSE9BZC0"}
<!doctype html>
<html lang="en">
  <head>
    <script>
...
```js {"id":"01J5DMK6V12H4R1CKKHDGXBPT0"}
import sum from './sum';
...
```js {"id":"01J5DMK6V12H4R1CKKHDQ8K29E"}
import React from 'react';
...
```sh {"id":"01J5DMK6V2Q2G5Z8GQMFRC64DC"}
npm install --save-dev enzyme react-addons-test-utils
```

```js {"id":"01J5DMK6V2Q2G5Z8GQMJ1JEKF0"}
import React from 'react';
...
```js {"id":"01J5DMK6V2Q2G5Z8GQMJKAE038"}
import React from 'react';
import { shallow } from 'enzyme';
import App from './App';
...
```js {"id":"01J5DMK6V2Q2G5Z8GQMP41NY38"}
...
```sh {"id":"01J5DMK6V2Q2G5Z8GQMS145Q2N"}
npm install --save-dev jest-enzyme
```

```js {"id":"01J5DMK6V2Q2G5Z8GQMTX1DGY0"}
// src/setupTests.js
import 'jest-enzyme';
```
...
```js {"id":"01J5DMK6V2Q2G5Z8GQMXPW3YGN"}
...
```js {"id":"01J5DMK6V3Z2VCWZA0AKDA041T"}
...
```yaml {"id":"01J5DMK6V3Z2VCWZA0AN0186RY"}
language: node_js
node_js:
  - 4
  - 6
...
```cmd {"id":"01J5DMK6V3Z2VCWZA0ARBXBNGB"}
set CI=true&&npm test
```

```cmd {"id":"01J5DMK6V3Z2VCWZA0ATRDPBAY"}
...
```bash {"id":"01J5DMK6V3Z2VCWZA0AX61M7HZ"}
CI=true npm test
```

```bash {"id":"01J5DMK6V3Z2VCWZA0B0KKN083"}
...
```js {"id":"01J5DMK6V4C9MWFT0BKC3KQDCJ"}
  // ...
  "scripts": {
    // ...
    "test": "react-scripts test --env=jsdom"
...
```sh {"id":"01J5DMK6V5QF847ND7FTESG27H"}
npm install -g getstorybook
```

Then, run the following command inside your app’s directory:

```sh {"id":"01J5DMK6V5QF847ND7FVJGBPXK"}
getstorybook
```
...
```sh {"id":"01J5DMK6V5QF847ND7FW53JZG8"}
npm install -g serve
serve -s build
```
...
```sh {"id":"01J5DMK6V6TEE93NQ0A3N11EHW"}
serve -h
```
...
```javascript {"id":"01J5DMK6V6TEE93NQ0A3PWEJT2"}
...
```diff {"id":"01J5DMK6V6TEE93NQ0A5Z9V6NH"}
 app.use(express.static('./build'));
...
```rb {"id":"01J5DMK6V6TEE93NQ0A76RP122"}
    Options -MultiViews
    RewriteEngine On
...
```js {"id":"01J5DMK6V6TEE93NQ0AAEH395J"}
...
```js {"id":"01J5DMK6V6TEE93NQ0AD09K0C6"}
  "homepage": ".",
```
...
```sh {"id":"01J5DMK6V7PGSA271X14ZQCQXD"}
    === Project Setup
...
```sh {"id":"01J5DMK6VB1DD3RREV1EM37CX5"}
...
```js {"id":"01J5DMK6VC5RX1VZ2HCMHG316Y"}
...
```sh {"id":"01J5DMK6VC5RX1VZ2HCPQ5Y4RJ"}
npm install --save-dev gh-pages
```

Add the following scripts in your `package.json`:

```js {"id":"01J5DMK6VC5RX1VZ2HCSY4GABA"}
  // ...
  "scripts": {
    // ...
...
```sh {"id":"01J5DMK6VC5RX1VZ2HCW90S5E6"}
npm run deploy
```
...
```yaml {"id":"01J5DMK6VDH1JQE47P6E2GVATZ"}
...
```yaml {"id":"01J5DMK6VDH1JQE47P6GRNP100"}
...
```sh {"id":"01J5DMK6VDH1JQE47P6H8G9R0Y"}
...
```sh {"id":"01J5DMK6VEXFGG8J5MV1QMK8FF"}
/*  /index.html  200
```
...
```sh {"id":"01J5DMK6VEXFGG8J5MV3CCEMY4"}
"now-start": "serve build/",
```

4. Run `now` from your project directory. You will see a **now.sh** URL in your output like this:

```md {"id":"01J5DMK6VEXFGG8J5MV78QQY10"}
...
```sh {"id":"01J5DMK6VEXFGG8J5MV7GHMGC7"}
...
```sh {"id":"01J5DMK6VFCNSD6CF1G2S75A9H"}
